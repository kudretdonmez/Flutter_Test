...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _incrementAsTransaction() async {
    ...
    final TransactionResult transactionResult = await _counterRef.runTransaction((MutableData mutableData) {
    ...
    if (transactionResult.committed) {
      await _messagesRef
          .push()
          .set(<String, String>{_kTestKey: '$_kTestValue ${transactionResult.dataSnapshot?.value}'});
    } else {
