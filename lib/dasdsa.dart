...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _createDB() {
    ...
    _dbref.child("carprofile").set({'car1': "family car", 'car2': "company car"});
  }

  _readdb_onechild() {
    _dbref.child("customer1").child("age").once().then((DataSnapshot dataSnapshot) {
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ListTile(
                          ...
                          subtitle: Text('Age: ${item[index]['age'].toString()} \nStatus: ${item[index]['status']}'),
                          isThreeLine: true,
                        );
                      },
                    ),
